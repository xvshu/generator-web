...
<head>
    <title>消息发送</title>
    <%@ include file="/common/static_kindeditor.jsp" %>
    <script type="text/javascript" src="${r"${fPath }"}/statics/js/message/sendMessage.js?v=${r"${fVersion}"}"></script>
    <script>
        var editor;
        $(function() {
    ...
    <div class="easyui-dialog" id="showSendMessageDialog" title="发送消息" style="display: none;width: 800px;height: auto;"
        ...
        <form name="contentForm" id="contentForm">
            ...
            <div style="margin:20px;" id="sendGroupDiv">
                ...
                <jsp:include page="../common/treeNode.jsp"/>
                </div>
            </div>
            <div style="margin:20px">
                内容：
