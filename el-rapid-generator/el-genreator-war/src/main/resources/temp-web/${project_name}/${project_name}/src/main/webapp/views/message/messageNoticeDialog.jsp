...
<script type="text/javascript" src="${r"${fPath }"}/statics/js/message/messageNoticeDialog.js?v=${r"${fVersion}"}"></script>
...
<script>
    ...
    $(function() {
        //五分钟请求一次
        messageNoticeTimer = setInterval("searchMessage()", 5*60*1000);
    })
</script>