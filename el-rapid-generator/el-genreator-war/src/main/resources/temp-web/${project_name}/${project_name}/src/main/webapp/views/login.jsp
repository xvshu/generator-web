...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${r"${fPath }"}/statics/css/login.css?v=${r"${fVersion}"}"/>

    <%@ include file="/common/head_script.jsp" %>
    <script type = "text/javascript" src = "${r"${fPath }"}/statics/js/checkCode.js?v=${r"${fVersion}"}"></script>
...
<div class="login">
    ...
    <div id="darkbannerwrap"></div>
		...
		<form onsubmit="return confirmLogin()" action="/pubserver/login/check" method="get">
...
<div class="copyright">xvshu© 2017 Demo  Login by<a href="https://www.eloancn.com/" target="_blank">翼龙贷</a></div>
</body>
</html>
