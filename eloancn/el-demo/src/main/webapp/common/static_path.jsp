...
<c:set var="iPath" value="${applicationScope['static.image.path']}"/>
<c:set var="iVersion" value="${applicationScope['static.image.path.version']}"/>
<c:set var="fPath" value="${applicationScope['static.file.path']}"/>
<c:set var="fVersion" value="${applicationScope['static.file.path.version']}"/>
