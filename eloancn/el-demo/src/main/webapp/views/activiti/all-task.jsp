	...
	<script type="text/javascript">
        ...
        function formatOper(val,row,index){
			...
			if(assigneeWF==null || assigneeWF==""){
                operHtml = "<a onclick=\"climeWF('${ctx }/activiti/task/claimWF/"+taskId+"')\" href=\"#\">签收</a>";
			}else{
...
<body>
	...
	<table id="dg" class="easyui-datagrid" title="所有待办任务列表" style="width:100%;height:auto;"
		   data-options="pagination:true,rownumbers:true,singleSelect:true,url:'${ctx }/activiti/list/taskall/findall',method:'post'">
		<thead>
		<tr>
