    ...
    */
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        try {
        	...
        	//String url=(String)SessionUtils.getSession().getAttribute("cas_url");
            ...
            user.setAssertion(casAssertion);
            Map<String, Object> attributes = casPrincipal.getAttributes();
            user.setUserName((String)attributes.get("realname"));
            user.setUserRealName((String)attributes.get("realname"));
            user.setEmail((String)attributes.get("email"));
            String mobile =(String)attributes.get("mobile");
            if(org.apache.commons.lang3.StringUtils.isNotEmpty(mobile))
            	mobile=DESUtils.getDecryptString(mobile);
            user.setMobile(mobile);
            String idcard =(String)attributes.get("idcard");
            if(org.apache.commons.lang3.StringUtils.isNotEmpty(idcard))
            	idcard=DESUtils.getDecryptString(idcard);
            
            user.setIdCard(idcard);
            String _userId = (String)attributes.get("mapperuid");
            //if(org.apache.commons.lang3.StringUtils.isBlank(_userId))
            //	_userId =(String)attributes.get("id");
            user.setUserId(_userId);
            user.setStatus((String)attributes.get("status"));
            user.setPaypassword((String)attributes.get("paypassword"));
            user.setPhoto((String)attributes.get("photo"));
            user.setAccountNum((String)attributes.get("accountNum"));
            user.setUserType((String)attributes.get("userType"));
            user.setRoles((String)attributes.get("role"));
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        //for (String attributeName : attributeNames) {
          //  String value = attributes.get(attributeName);
            addRoles(simpleAuthorizationInfo, split(user.getRoles()));
       // }
        // get permissions from attributes
        //attributeNames = split(permissionAttributeNames);
       // for (String attributeName : attributeNames) {
         //   String value = attributes.get(attributeName);
            addPermissions(simpleAuthorizationInfo, split(user.getPermissions()));
        //}
